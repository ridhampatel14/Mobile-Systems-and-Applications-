...
public class ViewPeersActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView peer_list=(ListView)findViewById(R.id.peer_list);
        peersAdapter=new ArrayAdapter<Peer>(this, android.R.layout.simple_list_item_1,peers);
        peer_list.setAdapter(peersAdapter);
