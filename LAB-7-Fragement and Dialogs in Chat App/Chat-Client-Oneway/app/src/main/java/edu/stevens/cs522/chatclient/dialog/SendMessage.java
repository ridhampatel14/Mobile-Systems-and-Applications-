...
public class SendMessage extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        destinationHost=(EditText)rootView.findViewById(R.id.destination_host);
        chatName=(EditText)rootView.findViewById(R.id.chat_name);
        messageText=(EditText)rootView.findViewById(R.id.message_text);
        chatroom=(EditText)rootView.findViewById(R.id.chat_room);
