    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)) {
            case MESSAGES_ALL_ROWS:
                ...
                //************************************************************8
//                String selection1 = MessageContract.SENDER + "=?";
//                String[] selectionArgs1 = new String[]{ values.getAsString("sender") };
//                Cursor cursor1 = query(uri, null, selection1, selectionArgs1, null);
                /*
...
//                    peerId1 = MessageContract.getId(cursor1);
//                    selection1 = MessageContract._ID + "=?";
//                    selectionArgs1 = new String[]{ Long.toString(peerId1) };
//                    long row=db.update(MESSAGES_TABLE, values, selection1, selectionArgs1);
//                    if(row>0){
//                        ContentResolver cr=getContext().getContentResolver();
//                        cr.notifyChange(uri,null);
//                        return ContentUris.withAppendedId(uri, row);
//                    }
//                } else {
//                    peerId1 = db.insert(MESSAGES_TABLE, null, values);
//                    if(peerId1>0){
//                        ContentResolver cr=getContext().getContentResolver();
//                        cr.notifyChange(uri,null);
//                        return ContentUris.withAppendedId(uri,peerId1);
//                    }
//                }
                /*
                 * End by returning the URI for the row (new or not).
                 */
                //return MessageContract.CONTENT_URI(peerId1);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            case MESSAGES_ALL_ROWS:
                 ...
                 */
                Cursor cursor1=db.query(MESSAGES_TABLE,projection,selection,selectionArgs,null,null,null,sortOrder);
